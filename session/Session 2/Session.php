...
class Session
{
     ...
     *
     * statements within this method will be executed just ONCE for
     * the entire application because we create an object of this
     * class just ONCE thanks to the singleton pattern
     */
     ...
     */
    public function flashRequest(): void
    {
